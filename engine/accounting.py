...
class Accounting:
    ...
    def equity_curve(self) -> pd.DataFrame:
        ...
        if not self.records:
            return pd.DataFrame(columns=["cash", "market_value", "equity", "available_cash", "total_fees"])
    ...
    def fills_frame(self) -> pd.DataFrame:
        ...
        if not self.fills:
            return pd.DataFrame(columns=[
                ...
                "fill_price", "exec_price", "commission", "stamp_tax",
                "transfer_fee", "total_fee", "cash_flow",
            ])
